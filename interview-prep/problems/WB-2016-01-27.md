...
public class WhiteboardProblems
{
    public static void main(String[] args)
    {
        ...
        assert bruteForce(numbers) : "BF: Uh roh. Didn't find 1,9 = 10";
        assert sortedBruteForce(numbers) : "SBF: Uh roh. Didn't find 1,9 = 10";
        assert mapSolution(numbers) : "Map: Uh roh. Didn't find 1,9 = 10";
        assert arraySolution(numbers) : "Array: Uh roh. Didn't find 1,9 = 10";
        System.out.println("PASS - 1+9 = 10");

        int[] numbers2 = {0,100,342,22,34};
        assert bruteForce(numbers2) : "BF: Uh roh. Thinks things sum to 10, but they don't";
        assert sortedBruteForce(numbers2) : "SBF: Uh roh. Thinks things sum to 10, but they don't";
        assert mapSolution(numbers2) : "Map: Uh roh. Thinks things sum to 10, but they don't";
        assert arraySolution(numbers2) : "Array: Uh roh. Thinks things sum to 10, but they don't";
    ...
    public static boolean bruteForce(int[] a)
    {
        for(int i = 0; i < a.length; i++)       // This loop is O(n)
            for(int j = i+1; i < a.length; j++) // This loop is O(n)
